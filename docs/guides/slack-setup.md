...
> setup, and the other owner-gated surfaces) are denied for it afterwards. The
> dashboard detects this case and shows a sign-in banner; run `kirocrew token`
> and open the fresh link to re-authenticate under the new owner.

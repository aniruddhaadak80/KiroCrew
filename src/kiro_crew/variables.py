...
def render_dotenv(pairs: Mapping[str, str]) -> str:
    ...
    A value containing a quote character needs no escaping, because only a MATCHING
    surrounding pair is stripped on the way back in — an interior quote is literal.
    """
    lines: list[str] = []

...
from kiro_crew.wecom.media import MAX_MEDIA_BYTES, download_media, media_items
...
#: real bound on a document AND on an audio file.
_WECOM_FILE_BYTES = 20 * 1024 * 1024

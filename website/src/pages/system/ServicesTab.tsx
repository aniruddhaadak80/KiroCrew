...
export default function ServicesTab() {
  ...
  // UNCONFIGURED channel looks like, and the payload carries nothing that
  // separates it from a configured channel that never started, so rendering every
  // key would put seven meaningless "Not connected" rows on a Slack-only install.
  // Settings > Channels is the surface that knows `configured` (it asks each
  // channel's own config endpoint) and is where "did I set this up?" belongs; this
  // page answers "is what I set up running, and if not, why not?".
  //
